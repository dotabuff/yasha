...
func (p *Parser) AsBaseEvent(commandName string) (proto.Message, error) {
	...
	case "DOTA_UM_PredictionResult":
		return &dota.CDOTAUserMsg_PredictionResult{}, nil
	case "DOTA_UM_ModifierAlert":
		return &dota.CDOTAUserMsg_ModifierAlert{}, nil
	case "DOTA_UM_HPManaAlert":
		return &dota.CDOTAUserMsg_HPManaAlert{}, nil
	case "DOTA_UM_GlyphAlert":
		return &dota.CDOTAUserMsg_GlyphAlert{}, nil
	case "DOTA_UM_BeastChat":
		return &dota.CDOTAUserMsg_BeastChat{}, nil
	case "DOTA_UM_SpectatorPlayerUnitOrders":
		return &dota.CDOTAUserMsg_SpectatorPlayerUnitOrders{}, nil
	}
	return nil, fmt.Errorf("Command type not found: %s", commandName)
}
func (p *Parser) AsBaseEventNETSVC(value int) (proto.Message, error) {
	...
	return nil, fmt.Errorf("NETSVC not found: %d", value)
}
func (p *Parser) AsBaseEventBUMDUM(value int) (proto.Message, error) {
	...
	return nil, fmt.Errorf("BUMDUM not found: %d", value)
}
